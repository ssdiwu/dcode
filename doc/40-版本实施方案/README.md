...
|---|---|---|---|
| [0030-0.0.32 工作台 UI/UX 产品需求](0030-工作台-UI-UX-并行候选.md) | OAuth候选基准 `b07564d`；2026-09-10 新反馈的系统钥匙串反复授权已完成源码修复、自动回归和独立审查，待新候选，旧候选不包含本修复；原窗口/连接/数据与人工验收边界保留，证据见该文档 | 目标 0.0.32，未定版、未整体人工验收、未合并或发布 | 新任务与主题、输入反馈、共享动效、技能浮层、行内 API 连接与可恢复 OAuth、可设置配额门槛、输入栏入口及已确认的原生证据查询缺口修复。固定 0.0.31 验收基线不替换，多目录项目后续待排期。 |
